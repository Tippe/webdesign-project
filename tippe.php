				...
				<div class="col-md-12">
					<div class="collapse" id="leerdoelen">
						<div class="card card-body">
							...
							<p>Leerdoel 3: Ik wil geen achterstanden opbouwen met het huiswerk. Dit ga ik doen door elke keer als we nieuw huiswerk krijgen dezelfde dag er veel aan werken om het direct af te krijgen. En als dat niet lukt dan de dag erna.</p>
						</div>
					</div>
				</div>
			</div>
