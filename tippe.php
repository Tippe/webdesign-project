...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<p>Vaak lukt het mij niet om optijd huiswerk in te leveren of af te krijgen.</p>
				...
				<div class="col-md-12">
					<div class="collapse" id="Leerdoelen">
						<div class="card card-body">
							...
							<p>Leerdoel 2: Ik ga er voor zorgen wanneer er groepsopdrachten zijn (of duo opdrachten) ik gelijk een partner vindt om er samen aan te werken in plaats van afwachten en niet op zoek gaan naar een partner. Hiermee zorg ik ervoor dat er in de eerste dag dat er een nieuw opdracht gemaakt moet worden direct een duo of groep is.</p>

							<p>Leerdoel 4: Ik wil geen achterstanden opbouwen met het huiswerk. Dit ga ik doen door elke keer als we nieuw huiswerk krijgen dezelfde dag er veel aan werken om het direct af te krijgen. En als dat niet lukt dan de dag erna.</p>
						</div>
					</div>
				</div>
			</div>
